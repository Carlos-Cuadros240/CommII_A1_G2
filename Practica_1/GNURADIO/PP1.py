...
import PP1_epy_block_0 as epy_block_0  # embedded python block
import PP1_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class PP1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "PP1")
        ...
        labels = ['Dif', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f((1, 0, -1), True, 1, [])
...
def main(top_block_cls=PP1, options=None):
